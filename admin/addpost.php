            ...
            <div class="box round first grid">
                ...
                if($_SERVER['REQUEST_METHOD']=='POST') {
                    ...
                    if($title=="" || $cat=="" || $body=="" || $tags=="" || $author=="" || $file_name=="" ){
                        ...
                        echo "<span style='color: red;font-size: 18px;'>Please Select An Image</span>";
                        ...
                        $query="insert into tbl_post(cat,title,body,image,author,tags,userid) values('$cat','$title','$body','$upload_image','$author','$tags','$userid')";
                 ...
                 <form action="addpost.php" method="post" enctype="multipart/form-data">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text"  name="author" value="<?php echo (Session::get('name')); ?>" class="medium" />
