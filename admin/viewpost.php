                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" readonly name="title" value="<?php echo $postresult['title']; ?>"
                                           class="medium"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?php echo $postresult['image']; ?>" height="70px" width="120px"><br>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" readonly name="author" value="<?php echo $postresult['author']; ?>"
